...
async function getUUID() {
    const decodedJSON = await fetch("../database/get/ajax/getDBDataForum.php?request=UUID")
        .then( res => res.json() );
    ...
    //     }
    // }
    // xmlhttp.open("GET", "../database/get/ajax/getDBDataForum.php?request=UUID", false);
    // xmlhttp.send();
    // return id;
}

async function getPlayerInfo(id) {
    const decodedJSON = await fetch("../database/get/ajax/getDBDataForum.php?request=PlayerInfo&1=" + id)
    .then( res => res.json() );
    ...
    //     }
    // }
    // xmlhttp.open("GET", "../database/get/ajax/getDBDataForum.php?request=PlayerInfo&1=" + id, false);
    // xmlhttp.send();
    // return datas;
}
...
async function AddMessageToDB(id, postDate, text, replyId, playerId, channelId) {
    fetch("../database/get/ajax/getDBDataForum.php?request=NewMessage&1=" + id + "&2=" + text + "&3=" + replyId + "&4=" + playerId + "&5=" + channelId)
    // var xmlhttp = new XMLHttpRequest();
    // xmlhttp.onreadystatechange = function () {
    // }

    // xmlhttp.open("GET", "../database/get/ajax/getDBDataForum.php?request=NewMessage&1=" + id + "&2=" + text + "&3=" + replyId + "&4=" + playerId + "&5=" + postDate + "&6=" + channelId);
    // xmlhttp.send();
}
...
async function AddChannelToDB(id, owner, title, keyWords, creationDate) {
    fetch("../database/get/ajax/getDBDataForum.php?request=NewChannel&1=" + id + "&2=" + owner + "&3=" + title + "&4=" + keyWords)
    // var xmlhttp = new XMLHttpRequest();
    // xmlhttp.onreadystatechange = function () {
    // }

    // xmlhttp.open("GET", `../database/get/ajax/getDBDataForum.php?request=
...
async function getFavorites(playerId) {
    const decodedJSON = await fetch("../database/get/ajax/getDBDataForum.php?request=GetFav&1=" + playerId)
    .then( res => res.json() );
...
async function getFavorite(playerId, themeId) {
    const decodedJSON = await fetch("../database/get/ajax/getDBDataForum.php?request=GetFav&1=" + playerId + "&2=" + themeId)
    .then( res => res.json() );
...
async function getMessages(channelId) {
    ...
    const decodedJSON = await fetch("../database/get/ajax/getDBDataForum.php?request=GetMessages&1=" + channelId)
    .then( res => res.json() );
...
async function setFavoriteTheme(bool) {
    ...
    fetch("../database/get/ajax/getDBDataForum.php?request=" + query);

    //var xmlhttp = new XMLHttpRequest();
    //xmlhttp.open("GET", `../database/get/ajax/getDBDataForum.php?request=` + query);
    //xmlhttp.send();
}
...
async function removeMessage(message) {
    if (playerValues == null)
        return;
    await fetch("../database/get/ajax/getDBDataForum.php?request=RemoveMessage&1=" + message.id + "&2=" + playerValues.dataset.id);
...
function updateMessage(message) {
    if (playerValues == null)
        return;
    fetch("../database/get/ajax/getDBDataForum.php?request=UpdateMessage&1=" + message.innerHTML.substr(0, message.innerHTML.length) + "&2=" + message.id + "&3=" + playerValues.dataset.id);
    // var xmlhttp = new XMLHttpRequest();
    // xmlhttp.open("GET", `../database/get/ajax/getDBDataForum.php?request=
