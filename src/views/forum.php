...
<body>
    ...
    <div id='forumFrame'>
        ...
        <div id='channel'>
            <img id='mobileBackArrow' src='../../public/img/backIcon.png' alt='retourAuxThemes' loading="lazy" decoding="async">
            <?php
            if (isset($_SESSION['LOGGED_USER'])) {
                $isFav = false;
            ...
            <div id='channelMessages'>
                ...
                for ($i = 0; $i < count($messageData); ++$i) {
                    echo '<div class=profile>
                        <img class=profilePicture src=\'../../public/img/' . $messageData[$i]['profilePicture'] . '\' alt=\'photo de profil\' loading=lazy decoding=async>
